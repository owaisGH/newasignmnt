...
import com.ows.uploadfiles.exception.StorageFileNotFoundException;
...
public class FileUploadTests {
    ...
    public void shouldListAllFiles() throws Exception {
        given(this.istorageService.loadAllFiles())
    ...
    public void shouldSaveUploadedFile() throws Exception {
        ...
        then(this.istorageService).should().storeFile(multipartFile);
    }

    @Test
    public void should404WhenMissingFile() throws Exception {
        given(this.istorageService.loadAsResource("test.txt"))
